...
- 最终的 `qtopia232_retainrest` 包修复 `nima` 这类连续全拼在选择首音节单字后误清空剩余拼音的问题。
...
```text
dist/murphytalk.pinyin_1.1.45_arm_jianpin_qtopia232_retainrest.ipk
```
...
```text
SHA256: c02f571a6540fea076805dd84be704eedc31d652062d52f8977e81547c4d0c05
```
