...
- 最终的 `qtopia232_splitui` 包修复 `nm` 这类连续简拼无法逐字输入的问题，并修复 Qt2 下关于入口/关于对话框中文乱码。
...
```text
dist/murphytalk.pinyin_1.1.45_arm_jianpin_qtopia232_splitui.ipk
```
...
```text
SHA256: c1f2f055444f7f5367c44ee768f8282d1c2ebc3b8397e1a2ab80b8f6de2e9000
```
